...
> Status update (2026-06-11): fixed admin security-header precedence,
> same-origin URL backslash bypasses, stale search-result races, PAT expiry
> enforcement, invalid OG SVG controls, auto-regeneration validation, and
> freshness-generation ordering. The full quality suite and browser smoke
> tests pass after canonical regeneration.
