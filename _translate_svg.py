...
TRANS = {
    ...
    # ─── vitiligo extras: study flowchart, risk stratification ───
    "兩者皆有&nbsp;": "Both",
    "長庚研究資料庫 患者篩選流程": "Chang Gung Research Database — patient selection flow",
    "CGRD 確診非分節型白斑": "CGRD-confirmed non-segmental vitiligo",
    "未達 inclusion 標準": "Did not meet inclusion criteria",
    "(穩定不足 6 個月或": "(less than 6 months stable, or",
    "追蹤不足 1 年等)": "less than 1 year of follow-up, etc.)",
    "初步符合 inclusion 標準": "Initially meet inclusion criteria",
    "排除 1,012 人：": "Excluded 1,012 patients:",
    "• 病歷不全 n = 926": "• Incomplete records n = 926",
    "• 分節型白斑 n = 79": "• Segmental vitiligo n = 79",
    "• 全量口服藥中惡化 n = 7": "• Worsening on full oral therapy n = 7",
    "最終分析族群": "Final analysis cohort",
    "復發 / relapse": "Relapse",
    "維持穩定": "Sustained stability",
    "Forest plot — Multivariable Cox 調整後 hazard ratio":
        "Forest plot — Multivariable Cox adjusted hazard ratio",
    "aHR = 1 (參考)": "aHR = 1 (reference)",
    "其他自體免疫": "Other autoimmune",
    "3-tier risk-stratified maintenance — 維持強度建議":
        "3-tier risk-stratified maintenance — intensity recommendations",
    "先盤點：是否有任一風險因子？": "Step 1: any risk factor present?",
    "手腳病灶 / 甲狀腺疾病 / 其他自體免疫":
        "Acral involvement / thyroid disease / other autoimmune",
    "皆無": "None",
    "單一因子": "Single factor",
    "acral + 任一免疫": "Acral + any immune-related",
    "1-yr 復發 ~ 23-27%": "1-yr relapse ~ 23-27%",
    "→ 每週 2 次 ×3-6 月": "→ Twice weekly × 3-6 months",
    "• Phototherapy 拉長": "• Phototherapy extended",
    "間隔至每 2 週": "to every 2 weeks",
    "• 6-12 月可考慮": "• At 6-12 months consider",
    "完全停藥觀察": "complete discontinuation + observe",
    "• 追蹤每 6 月": "• Follow-up every 6 months",
    "1-yr 復發 ~ 33-40%": "1-yr relapse ~ 33-40%",
    "• Topical 每週 2 次": "• Topical twice weekly",
    "持續 6-12 月": "for 6-12 months",
    "• 或 NB-UVB": "• Or NB-UVB",
    "每 1-2 週": "every 1-2 weeks",
    "• 不建議全部停": "• Do not discontinue all therapy",
    "• 追蹤每 3-6 月": "• Follow-up every 3-6 months",
    "• 甲狀腺 TSH 每 1-2 yr": "• Thyroid TSH every 1-2 years",
    "1-yr 復發 ~ 35-45%+": "1-yr relapse ~ 35-45%+",
    "• Topical 每週 2-3 次": "• Topical 2-3× weekly",
    "持續 ≥ 12 月": "for ≥ 12 months",
    "• NB-UVB 每週 1 次": "• NB-UVB weekly",
    "• 考慮低劑量": "• Consider low-dose",
    "systemic 維持": "systemic maintenance",
    "• 追蹤每 3 月": "• Follow-up every 3 months",
    "• 共照 內分泌 / 免疫科": "• Co-manage with endocrinology / immunology",
    "※ 建議僅供臨床思考、個別 modality 與療程需主治醫師依個案決定":
        "※ Recommendations are for clinical reasoning only; specific modality + duration should be individualized by the attending physician",
}
