...
(function () {
  ...
  DN.ARTICLES = [
    ...
    { slug:'ai-dermatology-roles', title:'AI 在皮膚科目前能做什麼？皮膚鏡熱圖、診斷輔助與醫學教育', title_en:'What can AI do in dermatology today? Dermoscopy heat maps, diagnostic support, and medical education', cat:'research', tag:'皮膚鏡 AI', date:'2026-05-16', emoji:'', tag_en:'AI in dermatology' , unpublished:true },
