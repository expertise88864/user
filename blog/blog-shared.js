...
(function () {
  ...
  DN.injectChartScrollCSS = function () {
    ...
    s.textContent =
      ...
      '.dn-chart-scroll table{ margin:0 !important; border-collapse:separate; border-spacing:0 }' +
      '.dn-chart-scroll thead th{ position:sticky; top:0; z-index:3; background:#f1ece4; box-shadow:inset 0 -1px 0 var(--line,#ebe4d8) }' +
