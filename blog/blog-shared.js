...
(function () {
  ...
  DN.medDiagrams = {
    ...
    'acne-pathogenesis': function () {
      return '<figure class="dn-med-fig"><svg viewBox="0 0 880 540" xmlns="http://www.w3.org/2000/svg" aria-labelledby="acne-path-title">' +
        '<title id="acne-path-title">痤瘡四大致病機轉</title>' +
        '<rect width="880" height="540" fill="#faf7f2" rx="10"/>' +
        '<text x="440" y="40" text-anchor="middle" font-family="Noto Serif TC,Georgia,serif" font-size="22" font-weight="700" fill="#0c5159">痤瘡 4 大致病機轉</text>' +
        // Step 1 — circle r=68, bigger fonts
        '<g transform="translate(40 90)"><circle cx="80" cy="80" r="68" fill="#fef9c3" stroke="#854d0e" stroke-width="2.5"/>' +
        '<text x="80" y="68" text-anchor="middle" font-family="Inter" font-size="22" font-weight="800" fill="#854d0e">①</text>' +
        '<text x="80" y="92" text-anchor="middle" font-family="Noto Sans TC" font-size="17" font-weight="700" fill="#854d0e">皮脂分泌</text>' +
        '<text x="80" y="115" text-anchor="middle" font-family="Noto Sans TC" font-size="17" font-weight="700" fill="#854d0e">增加</text>' +
        '<text x="80" y="180" text-anchor="middle" font-family="Inter" font-size="14" fill="#5e574e">Sebum (androgen)</text></g>' +
        // Arrow
        '<path d="M200 170 L240 170" stroke="#4d6358" stroke-width="3" marker-end="url(#arrow)"/>' +
        // Step 2
        '<g transform="translate(250 90)"><circle cx="80" cy="80" r="68" fill="#fed7aa" stroke="#9a3412" stroke-width="2.5"/>' +
        '<text x="80" y="68" text-anchor="middle" font-family="Inter" font-size="22" font-weight="800" fill="#9a3412">②</text>' +
        '<text x="80" y="92" text-anchor="middle" font-family="Noto Sans TC" font-size="17" font-weight="700" fill="#9a3412">毛囊角化</text>' +
        '<text x="80" y="115" text-anchor="middle" font-family="Noto Sans TC" font-size="17" font-weight="700" fill="#9a3412">異常</text>' +
        '<text x="80" y="180" text-anchor="middle" font-family="Inter" font-size="14" fill="#5e574e">Comedo formation</text></g>' +
        '<path d="M410 170 L450 170" stroke="#4d6358" stroke-width="3" marker-end="url(#arrow)"/>' +
        // Step 3
        '<g transform="translate(460 90)"><circle cx="80" cy="80" r="68" fill="#fee2e2" stroke="#991b1b" stroke-width="2.5"/>' +
        '<text x="80" y="68" text-anchor="middle" font-family="Inter" font-size="22" font-weight="800" fill="#991b1b">③</text>' +
        '<text x="80" y="92" text-anchor="middle" font-family="Inter" font-size="16" font-weight="700" font-style="italic" fill="#991b1b">C. acnes</text>' +
        '<text x="80" y="115" text-anchor="middle" font-family="Noto Sans TC" font-size="17" font-weight="700" fill="#991b1b">增生</text>' +
        '<text x="80" y="180" text-anchor="middle" font-family="Inter" font-size="14" fill="#5e574e">Bacterial proliferation</text></g>' +
        '<path d="M620 170 L660 170" stroke="#4d6358" stroke-width="3" marker-end="url(#arrow)"/>' +
        // Step 4
        '<g transform="translate(670 90)"><circle cx="80" cy="80" r="68" fill="#dc2626" stroke="#7f1d1d" stroke-width="2.5"/>' +
        '<text x="80" y="68" text-anchor="middle" font-family="Inter" font-size="22" font-weight="800" fill="#fff">④</text>' +
        '<text x="80" y="92" text-anchor="middle" font-family="Noto Sans TC" font-size="17" font-weight="700" fill="#fff">免疫發炎</text>' +
        '<text x="80" y="115" text-anchor="middle" font-family="Noto Sans TC" font-size="17" font-weight="700" fill="#fff">反應</text>' +
        '<text x="80" y="180" text-anchor="middle" font-family="Inter" font-size="14" fill="#5e574e">IL-1β / TLR2 / Th17</text></g>' +
        // Drug action labels — bigger fonts (15-16px)
        '<text x="120" y="335" text-anchor="middle" font-family="Inter" font-size="15" font-weight="700" fill="#0c5159">↓ Isotretinoin</text>' +
        '<text x="120" y="358" text-anchor="middle" font-family="Noto Sans TC" font-size="15" font-weight="700" fill="#0c5159">抗雄性素</text>' +
        '<text x="330" y="335" text-anchor="middle" font-family="Inter" font-size="15" font-weight="700" fill="#0c5159">↓ Retinoids</text>' +
        '<text x="330" y="358" text-anchor="middle" font-family="Noto Sans TC" font-size="15" font-weight="700" fill="#0c5159">角質溶解</text>' +
        '<text x="540" y="335" text-anchor="middle" font-family="Inter" font-size="15" font-weight="700" fill="#0c5159">↓ BPO</text>' +
        '<text x="540" y="358" text-anchor="middle" font-family="Noto Sans TC" font-size="15" font-weight="700" fill="#0c5159">抗生素</text>' +
        '<text x="750" y="335" text-anchor="middle" font-family="Inter" font-size="15" font-weight="700" fill="#0c5159">↓ Anti-IL</text>' +
        '<text x="750" y="358" text-anchor="middle" font-family="Noto Sans TC" font-size="15" font-weight="700" fill="#0c5159">杜鵑花酸</text>' +
        // Vertical down-arrows from each circle to its drug label group
        '<line x1="120" y1="252" x2="120" y2="318" stroke="#4d6358" stroke-width="2" stroke-dasharray="4 4"/>' +
        '<line x1="330" y1="252" x2="330" y2="318" stroke="#4d6358" stroke-width="2" stroke-dasharray="4 4"/>' +
        '<line x1="540" y1="252" x2="540" y2="318" stroke="#4d6358" stroke-width="2" stroke-dasharray="4 4"/>' +
        '<line x1="750" y1="252" x2="750" y2="318" stroke="#4d6358" stroke-width="2" stroke-dasharray="4 4"/>' +
        // Bottom note
        '<text x="440" y="445" text-anchor="middle" font-family="Noto Sans TC" font-size="15" fill="#5e574e">每個機轉對應不同藥物 — 中重度痘痘建議「組合治療」</text>' +
        '<text x="440" y="500" text-anchor="middle" font-family="Inter" font-size="13" fill="#8b8378">Source: AAD 2024 acne guideline · Dreno 2018 EADV consensus</text>' +
    ...
    'bpo-mechanism': function () {
      return '<figure class="dn-med-fig"><svg viewBox="0 0 880 480" xmlns="http://www.w3.org/2000/svg" aria-labelledby="bpo-title">' +
        '<title id="bpo-title">過氧化苯醯(BPO)殺菌機轉</title>' +
        '<rect width="880" height="480" fill="#faf7f2" rx="10"/>' +
        '<text x="440" y="38" text-anchor="middle" font-family="Noto Serif TC,Georgia,serif" font-size="22" font-weight="700" fill="#0c5159">過氧化苯醯 BPO 為何能殺菌</text>' +
        '<text x="440" y="64" text-anchor="middle" font-family="Noto Sans TC" font-size="15" fill="#5e574e">(且不像抗生素產生抗藥性)</text>' +
        // Box 1 — BPO  (bigger boxes 175x100, more breathing room)
        '<g transform="translate(40 110)"><rect x="0" y="0" width="175" height="100" rx="12" fill="#cffafe" stroke="#0c5159" stroke-width="2.2"/>' +
        '<text x="87.5" y="40" text-anchor="middle" font-family="Inter" font-size="20" font-weight="800" fill="#0c5159">BPO</text>' +
        '<text x="87.5" y="64" text-anchor="middle" font-family="Noto Sans TC" font-size="14" fill="#5e574e">過氧化苯醯</text>' +
        '<text x="87.5" y="84" text-anchor="middle" font-family="Inter" font-size="13" fill="#5e574e">2.5–10%</text></g>' +
        // Arrow 1
        '<path d="M220 160 L260 160" stroke="#4d6358" stroke-width="3" marker-end="url(#arrow2)"/>' +
        '<text x="240" y="146" text-anchor="middle" font-family="Noto Sans TC" font-size="13" fill="#4d6358">+ 半胱胺酸</text>' +
        // Box 2 — ROS
        '<g transform="translate(265 110)"><rect x="0" y="0" width="200" height="100" rx="12" fill="#fed7aa" stroke="#9a3412" stroke-width="2.2"/>' +
        '<text x="100" y="40" text-anchor="middle" font-family="Inter" font-size="17" font-weight="800" fill="#9a3412">苯甲酸 → ·OH</text>' +
        '<text x="100" y="64" text-anchor="middle" font-family="Noto Sans TC" font-size="14" fill="#5e574e">自由基產生</text>' +
        '<text x="100" y="84" text-anchor="middle" font-family="Inter" font-size="13" fill="#5e574e">(ROS、活性氧)</text></g>' +
        // Arrow 2
        '<path d="M470 160 L510 160" stroke="#4d6358" stroke-width="3" marker-end="url(#arrow2)"/>' +
        '<text x="490" y="146" text-anchor="middle" font-family="Noto Sans TC" font-size="13" fill="#4d6358">氧化攻擊</text>' +
        // Box 3 — bacteria membrane
        '<g transform="translate(515 110)"><rect x="0" y="0" width="215" height="100" rx="12" fill="#fee2e2" stroke="#dc2626" stroke-width="2.2"/>' +
        '<text x="107.5" y="40" text-anchor="middle" font-family="Noto Sans TC" font-size="17" font-weight="800" fill="#dc2626">細菌膜破壞</text>' +
        '<text x="107.5" y="64" text-anchor="middle" font-family="Inter" font-size="14" font-style="italic" fill="#5e574e">C. acnes</text>' +
        '<text x="107.5" y="84" text-anchor="middle" font-family="Inter" font-size="13" fill="#5e574e">蛋白質 / DNA 氧化</text></g>' +
        // Arrow 3
        '<path d="M735 160 L775 160" stroke="#4d6358" stroke-width="3" marker-end="url(#arrow2)"/>' +
        // Box 4 — kill / no resistance
        '<g transform="translate(780 110)"><rect x="0" y="0" width="65" height="100" rx="12" fill="#dcfce7" stroke="#14532d" stroke-width="2.2"/>' +
        '<text x="32.5" y="50" text-anchor="middle" font-family="Noto Sans TC" font-size="16" font-weight="800" fill="#14532d">殺菌</text>' +
        '<text x="32.5" y="74" text-anchor="middle" font-family="Noto Sans TC" font-size="12" fill="#5e574e">無抗藥性</text></g>' +
        // Explanation card — well below the boxes
        '<rect x="60" y="260" width="760" height="160" rx="12" fill="#fff" stroke="#a5f3fc" stroke-width="1.8"/>' +
        '<text x="440" y="294" text-anchor="middle" font-family="Noto Sans TC" font-size="17" font-weight="700" fill="#0c5159">為什麼 BPO 不會產生抗藥性?</text>' +
        '<text x="440" y="328" text-anchor="middle" font-family="Noto Sans TC" font-size="14" fill="#5e574e">BPO 的「自由基」是非特異性氧化攻擊、</text>' +
        '<text x="440" y="352" text-anchor="middle" font-family="Noto Sans TC" font-size="14" fill="#5e574e">細菌無法演化出單一靶點突變來抵抗。</text>' +
        '<text x="440" y="386" text-anchor="middle" font-family="Noto Sans TC" font-size="14" fill="#5e574e">因此它常用來「搭配」抗生素以降低抗生素抗藥率。</text>' +
        '<text x="440" y="406" text-anchor="middle" font-family="Inter" font-size="12" fill="#8b8378">(Plewig &amp; Kligman, 2024)</text>' +
        '<text x="440" y="455" text-anchor="middle" font-family="Inter" font-size="13" fill="#8b8378">Source: Sagransky JAAD 2009 · Plewig Acne 4th ed 2024 · BPO 2.5% ≈ 5% 同效但耐受佳</text>' +
    ...
    'mast-cell': function () {
      return '<figure class="dn-med-fig"><svg viewBox="0 0 820 400" xmlns="http://www.w3.org/2000/svg" aria-labelledby="mast-title">' +
        '<title id="mast-title">蕁麻疹肥大細胞釋放機轉</title>' +
        '<rect width="820" height="400" fill="#faf7f2" rx="10"/>' +
        '<text x="410" y="36" text-anchor="middle" font-family="Noto Serif TC,Georgia,serif" font-size="20" font-weight="700" fill="#0c5159">蕁麻疹 — 肥大細胞活化的致病軸</text>' +
        // Triggers (left) — bigger box, bigger fonts
        '<g transform="translate(40 80)">' +
        '<rect x="0" y="0" width="170" height="200" rx="12" fill="#fef9c3" stroke="#854d0e" stroke-width="1.8"/>' +
        '<text x="85" y="28" text-anchor="middle" font-family="Inter" font-size="16" font-weight="700" fill="#854d0e">觸發</text>' +
        '<text x="14" y="62" font-family="Noto Sans TC" font-size="14" fill="#5e574e">• IgE(過敏)</text>' +
        '<text x="14" y="92" font-family="Noto Sans TC" font-size="14" fill="#5e574e">• 物理(壓 / 冷 / 熱)</text>' +
        '<text x="14" y="122" font-family="Noto Sans TC" font-size="14" fill="#5e574e">• 自體抗體(CSU)</text>' +
        '<text x="14" y="152" font-family="Noto Sans TC" font-size="14" fill="#5e574e">• 偽過敏(NSAID)</text>' +
        '<text x="14" y="182" font-family="Noto Sans TC" font-size="14" fill="#5e574e">• 感染 / 壓力</text>' +
        '</g>' +
        // Arrow 1
        '<path d="M215 180 L 265 180" stroke="#4d6358" stroke-width="2.5" marker-end="url(#arrowM)"/>' +
        // Mast cell (center)
        '<g transform="translate(275 100)">' +
        '<circle cx="80" cy="80" r="68" fill="#fed7aa" stroke="#9a3412" stroke-width="2.8"/>' +
        // Granules
        '<circle cx="60" cy="65" r="7" fill="#dc2626"/><circle cx="100" cy="58" r="6" fill="#dc2626"/>' +
        '<circle cx="110" cy="90" r="7" fill="#dc2626"/><circle cx="65" cy="95" r="6" fill="#dc2626"/>' +
        '<circle cx="85" cy="105" r="5" fill="#dc2626"/><circle cx="55" cy="80" r="5" fill="#dc2626"/>' +
        '<text x="80" y="180" text-anchor="middle" font-family="Inter" font-size="16" font-weight="700" fill="#9a3412">Mast Cell</text>' +
        '<text x="80" y="200" text-anchor="middle" font-family="Noto Sans TC" font-size="14" fill="#5e574e">皮膚肥大細胞</text>' +
        '</g>' +
        // Arrow 2
        '<path d="M450 180 L 500 180" stroke="#4d6358" stroke-width="2.5" marker-end="url(#arrowM)"/>' +
        '<text x="475" y="170" text-anchor="middle" font-family="Noto Sans TC" font-size="14" fill="#4d6358">脫顆粒</text>' +
        // Mediators (right) — wider box, bigger fonts
        '<g transform="translate(510 80)">' +
        '<rect x="0" y="0" width="280" height="200" rx="12" fill="#fee2e2" stroke="#dc2626" stroke-width="1.8"/>' +
        '<text x="140" y="28" text-anchor="middle" font-family="Inter" font-size="16" font-weight="700" fill="#dc2626">釋放介質 → 症狀</text>' +
        '<text x="14" y="62" font-family="Noto Sans TC" font-size="14" fill="#5e574e"><tspan font-weight="700">組織胺</tspan> → 血管擴張、癢</text>' +
        '<text x="14" y="92" font-family="Noto Sans TC" font-size="14" fill="#5e574e"><tspan font-weight="700">類胰蛋白酶</tspan> → 發炎</text>' +
        '<text x="14" y="122" font-family="Noto Sans TC" font-size="14" fill="#5e574e"><tspan font-weight="700">PGD₂ / LTC₄</tspan> → 血管通透性</text>' +
        '<text x="14" y="152" font-family="Noto Sans TC" font-size="14" fill="#5e574e"><tspan font-weight="700">PAF</tspan> → 風團</text>' +
        '<text x="14" y="182" font-family="Noto Sans TC" font-size="14" fill="#5e574e"><tspan font-weight="700">細胞激素</tspan> → 慢性</text>' +
        '</g>' +
        // Drug targets — moved down with more breathing room
        '<text x="410" y="320" text-anchor="middle" font-family="Noto Sans TC" font-size="15" font-weight="700" fill="#0c5159">藥物作用點</text>' +
        '<text x="410" y="346" text-anchor="middle" font-family="Noto Sans TC" font-size="14" fill="#5e574e">2H1 抗組織胺(一線) → Omalizumab(IgE 阻斷) → Cyclosporine / Dupilumab(難治型)</text>' +
        '<text x="410" y="380" text-anchor="middle" font-family="Inter" font-size="12.5" fill="#8b8378">Source: Zuberbier 2022 EAACI guideline · Kolkhir JAMA 2024 CSU review</text>' +
    ...
    'rosacea-subtypes': function () {
      return '<figure class="dn-med-fig"><svg viewBox="0 0 720 320" xmlns="http://www.w3.org/2000/svg" aria-labelledby="rosacea-title">' +
        ...
        '<text x="70" y="155" text-anchor="middle" font-family="Inter" font-size="13" font-weight="700" fill="#dc2626">ETR</text>' +
        '<text x="70" y="172" text-anchor="middle" font-family="Inter" font-size="13" fill="#5e574e">紅斑微血管擴張</text>' +
        '<text x="70" y="186" text-anchor="middle" font-family="Inter" font-size="13" fill="#8b8378">Erythematotelangiectatic</text>' +
        '<text x="70" y="216" text-anchor="middle" font-family="Inter" font-size="13" fill="#0c5159">→ Brimonidine / PDL</text>' +
        '</g>' +
        ...
        '<text x="70" y="155" text-anchor="middle" font-family="Inter" font-size="13" font-weight="700" fill="#dc2626">PPR</text>' +
        '<text x="70" y="172" text-anchor="middle" font-family="Inter" font-size="13" fill="#5e574e">丘疹膿皰</text>' +
        '<text x="70" y="186" text-anchor="middle" font-family="Inter" font-size="13" fill="#8b8378">Papulopustular</text>' +
        '<text x="70" y="216" text-anchor="middle" font-family="Inter" font-size="13" fill="#0c5159">→ Ivermectin / 口服</text>' +
        '</g>' +
        ...
        '<text x="70" y="155" text-anchor="middle" font-family="Inter" font-size="13" font-weight="700" fill="#9a3412">Phymatous</text>' +
        '<text x="70" y="172" text-anchor="middle" font-family="Inter" font-size="13" fill="#5e574e">鼻贅(rhinophyma)</text>' +
        '<text x="70" y="186" text-anchor="middle" font-family="Inter" font-size="13" fill="#8b8378">皮脂腺增生</text>' +
        '<text x="70" y="216" text-anchor="middle" font-family="Inter" font-size="13" fill="#0c5159">→ CO₂ 雷射</text>' +
        '</g>' +
        ...
        '<text x="70" y="155" text-anchor="middle" font-family="Inter" font-size="13" font-weight="700" fill="#854d0e">Ocular</text>' +
        '<text x="70" y="172" text-anchor="middle" font-family="Inter" font-size="13" fill="#5e574e">眼酒糟</text>' +
        '<text x="70" y="186" text-anchor="middle" font-family="Inter" font-size="13" fill="#8b8378">乾澀 / 結膜炎</text>' +
        '<text x="70" y="216" text-anchor="middle" font-family="Inter" font-size="13" fill="#0c5159">→ 眼科 + 口服 doxy</text>' +
        '</g>' +
        '<text x="360" y="290" text-anchor="middle" font-family="Noto Sans TC" font-size="13" fill="#5e574e">⚠ 用治痘痘的高濃度 retinoid 常會加重玫瑰斑 — 治療策略完全不同</text>' +
        '<text x="360" y="310" text-anchor="middle" font-family="Inter" font-size="13" fill="#8b8378">Source: Wilkin NRS 2002 · Schaller 2017 ROSCO consensus · Reinholz S2k 2022</text>' +
