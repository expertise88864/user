  ...
  DN.medDiagrams = {
    ...
    'mast-cell': function () {
      return '<figure class="dn-med-fig"><svg viewBox="0 0 720 320" xmlns="http://www.w3.org/2000/svg" aria-labelledby="mast-title">' +
        ...
        '<text x="65" y="22" text-anchor="middle" font-family="Inter" font-size="13" font-weight="700" fill="#854d0e">觸發</text>' +
        '<text x="10" y="48" font-family="Inter" font-size="13" fill="#5e574e">• IgE（過敏）</text>' +
        '<text x="10" y="68" font-family="Inter" font-size="13" fill="#5e574e">• 物理（壓 / 冷 / 熱）</text>' +
        '<text x="10" y="88" font-family="Inter" font-size="13" fill="#5e574e">• 自體抗體 (CSU)</text>' +
        '<text x="10" y="108" font-family="Inter" font-size="13" fill="#5e574e">• 偽過敏(NSAID)</text>' +
        '<text x="10" y="128" font-family="Inter" font-size="13" fill="#5e574e">• 感染 / 壓力</text>' +
        '</g>' +
        ...
        '<text x="80" y="155" text-anchor="middle" font-family="Inter" font-size="13" font-weight="700" fill="#9a3412">Mast Cell</text>' +
        '<text x="80" y="170" text-anchor="middle" font-family="Inter" font-size="13" fill="#5e574e">皮膚肥大細胞</text>' +
        '</g>' +
        '<path d="M390 150 L 435 150" stroke="#4d6358" stroke-width="2" marker-end="url(#arrowM)"/>' +
        '<text x="412" y="142" text-anchor="middle" font-family="Inter" font-size="13" fill="#4d6358">脫顆粒</text>' +
        // Mediators (right)
        '<g transform="translate(440 70)">' +
        '<rect x="0" y="0" width="240" height="160" rx="10" fill="#fee2e2" stroke="#dc2626" stroke-width="1.5"/>' +
        '<text x="120" y="22" text-anchor="middle" font-family="Inter" font-size="13" font-weight="700" fill="#dc2626">釋放介質 → 症狀</text>' +
        '<text x="10" y="48" font-family="Inter" font-size="13" fill="#5e574e"><tspan font-weight="700">組織胺</tspan> → 血管擴張、癢</text>' +
        '<text x="10" y="68" font-family="Inter" font-size="13" fill="#5e574e"><tspan font-weight="700">類胰蛋白酶</tspan> → 發炎</text>' +
        '<text x="10" y="88" font-family="Inter" font-size="13" fill="#5e574e"><tspan font-weight="700">PGD₂ / LTC₄</tspan> → 血管通透性</text>' +
        '<text x="10" y="108" font-family="Inter" font-size="13" fill="#5e574e"><tspan font-weight="700">PAF</tspan> → 風團</text>' +
        '<text x="10" y="128" font-family="Inter" font-size="13" fill="#5e574e"><tspan font-weight="700">細胞激素</tspan> → 慢性</text>' +
        '</g>' +
        // Drug targets
        '<text x="360" y="265" text-anchor="middle" font-family="Noto Sans TC" font-size="13" font-weight="700" fill="#0c5159">藥物作用點</text>' +
        '<text x="360" y="285" text-anchor="middle" font-family="Inter" font-size="13" fill="#5e574e">2H1 抗組織胺（一線） → Omalizumab(IgE 阻斷）→ Cyclosporine / Dupilumab（難治型）</text>' +
        '<text x="360" y="305" text-anchor="middle" font-family="Inter" font-size="13" fill="#8b8378">Source: Zuberbier 2022 EAACI guideline · Kolkhir JAMA 2024 CSU review</text>' +
