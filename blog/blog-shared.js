...
(function () {
  ...
  DN.ARTICLES = [
    ...
    { slug:'skin-biopsy-excision', title:'皮膚切片與腫瘤切除手術完整衛教 — 為什麼要切？怎麼切？術後怎麼照顧？', cat:'rx', tag:'處置 / 手術', date:'2026-05-09', emoji:'', tag_en:'Skin biopsy & excision' },
    { slug:'psoriasis-overview',  title:'乾癬完整衛教 — 分型、嚴重度、誘發因子', cat:'rx', tag:'乾癬', date:'2026-05-09', emoji:'', tag_en:'Psoriasis overview' },
    { slug:'psoriasis-topical',   title:'乾癬外用藥治療 — 類固醇、維生素 D、特殊部位', cat:'rx', tag:'乾癬', date:'2026-05-09', emoji:'', tag_en:'Psoriasis topical' },
    { slug:'psoriasis-systemic',  title:'乾癬全身性治療 — 光療、口服、生物製劑', cat:'rx', tag:'乾癬', date:'2026-05-09', emoji:'', tag_en:'Psoriasis systemic' },
    { slug:'psoriasis-special-populations', title:'乾癬合併症與特殊族群 — PsA、心血管、懷孕、兒童、指甲、紅皮症', cat:'rx', tag:'乾癬', date:'2026-05-09', emoji:'', tag_en:'Psoriasis special populations' },
