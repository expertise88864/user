...
(function () {
  ...
  DN.ARTICLES = [
    ...
    { slug:'ai-dermatology-roles', title:'AI 現在能幫皮膚科醫師看病嗎？2026 JAAD 眼動追蹤研究的三個現實答案', title_en:'Can AI help dermatologists diagnose today? Three realistic answers from the 2026 JAAD eye-tracking study', cat:'research', tag:'AI 與皮膚科', date:'2026-05-16', emoji:'', tag_en:'AI in dermatology' },
    { slug:'vitiligo-maintenance-clinical', title:'白斑停藥後會復發嗎？維持治療與復發風險評估 — 2026 BJD 長庚 809 人世代', title_en:'Does vitiligo come back after stopping? Maintenance and recurrence risk — Br J Dermatol 2026 CGMH 809-patient cohort', cat:'research', tag:'白斑復發', date:'2026-05-23', emoji:'', tag_en:'Vitiligo relapse' },
