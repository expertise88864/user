...
// dn-articles-desc:start
  DN.ARTICLES_DESC = {
    ...
    'acne-scar-treatment': {desc:'冰鑿、廂車、滾動凹疤怎麼分？紅疤多久會退？黑色素沉著怎麼淡化？肥厚疤、蟹足腫怎麼處理？痘疤完整治療指引 — 飛梭雷射、皮秒蜂巢、TCA CROSS、皮下分離、玻尿酸填補、類固醇注射，陳翊嘉醫師（皮膚科）整理 4 種凹疤治療對照表與選擇邏輯。',desc_en:'Acne scar treatment is the most challenging Identifying scar type completely different Identifying the 4 atrophic scar subtypes Best treatment combinations Cost and...'},
    'actinic-keratosis-scc': {desc:'日光性角化症是皮膚癌前病變、會進展為皮膚鱗狀細胞癌。本文整理 BAD 2017／AAD 2021／BAD 2022 波文氏症（SCC in situ）／BAD 2020 cSCC 等五大指引：Olsen 分級、轉化風險、cryotherapy／5-FU／imiquimod／PDT／手術切除／Mohs／放射治療、高風險鱗狀細胞癌評估、',desc_en:'Actinic keratosis (AK) precancerous skin lesion Bowen disease cutaneous SCC in situ cutaneous squamous cell carcinoma (cSCC) the same UV-driven carcinogenic spectrum'},
    'ai-dermatology-roles': {desc:'2026 JAAD 最新研究：DEXI 皮膚鏡 AI 熱圖和皮膚科醫師眼動熱圖有重疊（r=0.540），但 5/20 顆黑色素瘤被 AI 判成痣。給病人與住院醫師的雙軌解讀：AI 在皮膚科目前能做什麼、不能做什麼。',desc_en:'Resident-level research review integrating 2026 JAAD Reviews and the JAAD eye-tracking study comparing dermatologist gaze maps with DEXI dermoscopy AI heat maps...'},
    'alopecia-areata': {desc:'圓禿（Alopecia areata，俗稱鬼剃頭）是自體免疫疾病。台灣終生風險 1.7-2.1%、85.5% 在 40 歲前發病。用 SALT 分級評估嚴重度，輕中度可用病灶內類固醇注射、外用類固醇、Minoxidil；重度可用口服類固醇、JAK 抑制劑(Baricitinib、Ritlecitinib)。',desc_en:'Autoimmune 85.5% of patients develop disease before age 40 From 2024 onward: JAK inhibitors (baricitinib, ritlecitinib) strong recommendation (↑↑)'},
    ...
    'atopic-dermatitis-special-populations': {desc:'異位性皮膚炎不只是皮膚病：氣喘、過敏性鼻炎、食物過敏、嗜伊紅性食道炎、憂鬱與自殺風險、心血管、感染（葡萄球菌／HSV／疣／黴菌）、白內障與圓錐角膜；懷孕與哺乳藥物選擇、嬰兒與幼童、老年人。整合 AAD 2022 + 2023 兒童 + UpToDate 2024。',desc_en:'AD is the skin manifestation of systemic Th2 hyperactivity . AAD 2022 comorbidities guideline (Davis): seven essential screens — asthma (30-50%), allergic rhinitis...'},
    ...
    'psoriasis-special-populations': {desc:'乾癬合併症（乾癬性關節炎 PsA、心血管疾病、代謝症候群、肝病 NAFLD、憂鬱、發炎性腸道疾病）篩檢建議與處理；特殊族群（懷孕、哺乳、兒童、指甲乾癬、紅皮症型）治療策略。整理 AAD-NPF 2019 合併症指引、2020 兒童指引、UpToDate 2024。',desc_en:'Psoriasis comorbidities and special populations: psoriatic arthritis screening, cardiovascular risk, pregnancy / breastfeeding biologic safety, pediatric...'},
    ...
    'shingles-myths': {desc:'皮蛇繞一圈會死？是壓力造成？年輕人不會得？抗病毒藥要 72 小時內吃？Shingrix 疫苗值得嗎？痛要痛多久？6 個民眾最常誤會的帶狀皰疹（herpes zoster）觀念，陳翊嘉醫師（皮膚科）整理，附 dermatome 分布圖、抗病毒治療階梯、Shingrix vs Zostavax 比較。',desc_en:'Shingles varicella zoster virus (VZV) Antiviral not started within 72 hours Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical...'},
    'skin-biopsy-excision': {desc:'皮膚切片（shave／punch／incisional／excisional）與良性腫瘤切除手術完整衛教：4 種切片技術、指甲切片、痣／老人斑／脂肪瘤等良性腫瘤、ABCDE 警訊、梭形切除與 Langer 線、麻醉、縫合、術後敷料、洗澡時機（含 Heal 2006 BMJ 實證）、拆線時間、健保自費。',desc_en:'Patient-friendly dermatology guide to skin biopsy and tumor excision: indications, technique, post-op wound care, scar care, and follow-up. Integrates AAD biopsy...'},
    ...
    'topical-steroids-guide': {desc:'類固醇藥膏怎麼分強弱？臉、身體、手腳該用哪一級？指尖單位 (FTU) 怎麼算？可以擦多久？可以擦在臉上嗎？懷孕能用嗎？TCI(Tacrolimus、Pimecrolimus、Crisaborole)是什麼？本文完整整理 7 級類固醇藥膏分類、台灣常見品名、使用部位對照、停藥反彈、類固醇恐懼症 (TCS phobia) 解析。',desc_en:'Topical corticosteroid (TCS) phobia Right site, right potency, right duration Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical...'},
    'urticaria-myths': {desc:'蕁麻疹一定是吃到過敏的東西嗎？反覆發作是免疫力差嗎？抗組織胺會嗜睡上癮？會不會傳染給家人？慢性蕁麻疹治不好？食物過敏原檢測有用嗎？6 個民眾最常誤會的蕁麻疹（風疹塊）觀念，陳翊嘉醫師（皮膚科）整理，附風疹塊形成 SVG 圖、抗組織胺與生物製劑治療階梯。',desc_en:'Wheal Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical literature and clinical guidelines.'},
    'vitiligo': {desc:'白斑（Vitiligo）是自體免疫性皮膚色素脫失疾病，全球盛行率 1-2%。本文依臺灣皮膚科醫學會 2024 白斑臨床治療共識整理：分節型 vs 非分節型分類、外用藥（Ruxolitinib、Tacrolimus、皮質類固醇）、NB-UVB 光療、308nm Excimer、口服低脈衝類固醇、合併治療、維持治療、',desc_en:'Autoimmune-mediated skin depigmentation Topical ruxolitinib (Opzelura, JAK inhibitor) received FDA approval in 2022 This article integrates the TDA 2024 vitiligo...'},
    'vitiligo-maintenance-clinical': {desc:'非分節型白斑治療成功後仍有約三分之一會復發。本文整理 Shih HY、Ng CY 等 2026 年 Br J Dermatol 長庚 809 人世代研究：手腳病灶、甲狀腺病、其他自體免疫共病是三大獨立預測因子；手腳合併甲狀腺風險約 2.5 倍。提供患者衛教 + 臨床維持治療強度分層建議。',desc_en:'After 6 months of stability following successful repigmentation, about one-third (32.9%) of patients with non-segmental vitiligo experience recurrence/relapse within...'},
