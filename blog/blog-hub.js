...
// dn-articles-desc:start
  DN.ARTICLES_DESC = {
    ...
    'ai-dermatology-roles': {desc:'2026 三篇 JAAD 研究綜合：Kremer 眼動追蹤（DEXI 熱圖 r=0.540、但 5/20 顆黑色素瘤誤判）、Mahajan 多模態 LLM 看 12 種發炎性皮膚病（GPT-5 46.2%、深膚色準確率掉 13%）、Cao 數位轉錄秘書（皮膚科每天省 15.4 分鐘、高量門診更受益）。給病人與住院醫師的三條前線：影像辨識、解釋自己、寫病歷。',desc_en:'Resident-level research review integrating 2026 JAAD Reviews and the JAAD eye-tracking study comparing dermatologist gaze maps with DEXI dermoscopy AI heat maps...'},
