...
// dn-articles-desc:start
  DN.ARTICLES_DESC = {
    ...
    'acne-scar-treatment': {desc:'痘疤完整治療指引：冰鑿 / 廂車 / 滾動凹疤怎麼分？紅疤、黑色素沉著、肥厚疤、蟹足腫如何處理？4 種凹疤治療對照表 + 飛梭雷射 / TCA CROSS / 皮下分離選擇邏輯。',desc_en:'Acne scar treatment is the most challenging Identifying scar type completely different Identifying the 4 atrophic scar subtypes Best treatment combinations Cost and...'},
    ...
    'ai-dermatology-roles': {desc:'AI 在皮膚科 2026 三條前線：影像辨識(Kremer 眼動 r=0.540、5/20 黑色素瘤誤判)、發炎性皮膚病(Mahajan GPT-5 46.2%、深膚色掉 13%)、寫病歷(Cao DAX 每天省 15.4 min)。',desc_en:'Resident-level research review integrating 2026 JAAD Reviews and the JAAD eye-tracking study comparing dermatologist gaze maps with DEXI dermoscopy AI heat maps...'},
    'alopecia-areata': {desc:'圓禿(Alopecia areata、俗稱鬼剃頭)是自體免疫疾病、台灣終生風險 1.7-2.1%。SALT 分級評估嚴重度、輕中度用病灶內類固醇注射 + Minoxidil、重度用 JAK 抑制劑(Baricitinib)。',desc_en:'Autoimmune 85.5% of patients develop disease before age 40 From 2024 onward: JAK inhibitors (baricitinib, ritlecitinib) strong recommendation (↑↑)'},
    ...
    'biologics-overview': {desc:'皮膚科生物製劑 + 小分子標靶藥完整總覽：Dupilumab、Secukinumab、Guselkumab、Risankizumab、Adalimumab、JAK 抑制劑等 — 機轉、適應症、施打頻率、健保 / 自費價格、副作用、必要篩檢一次看完。',desc_en:'Biologics and small-molecule targeted drugs precision therapies capable of achieving “skin clearance”'},
    'contact-dermatitis': {desc:'接觸性皮膚炎分過敏型(ACD)與刺激型(ICD)兩大類：常見過敏原(鎳、香料、防腐劑、染髮劑)、Patch Test 判讀、避開過敏原、外用類固醇 / TCI、光療。整理 BAD 2017 指引。',desc_en:'Allergic contact dermatitis (ACD) Irritant contact dermatitis (ICD) Correct diagnosis requires patch testing Identify and avoid the trigger'},
    'cutaneous-t-cell-lymphoma': {desc:'皮膚 T 細胞淋巴瘤（CTCL）75% 為蕈狀肉芽腫（MF）。本文整理 TDA 2024 共識的診斷、TNMB 分期、外用 / NB-UVB / PUVA、Bexarotene、Methotrexate、生物製劑與鑑別診斷重點。皮膚科醫師整理。',desc_en:'Rare non-Hodgkin lymphoma 75% are mycosis fungoides (MF) TDA + Hematology and Oncology Society of Taiwan 2024 joint consensus'},
    'dermatologic-oral-examination': {desc:'嘴破超過兩週、嘴唇白色蕾絲狀紋路、牙齦反覆剝離——不是牙科是皮膚科。整理口腔扁平苔癬、復發性口瘡、口腔白斑(檳榔風險)、類天疱瘡、光線性唇炎 6 大病灶 + 切片時機。',desc_en:'An ulcer not healing in 2 weeks, white lacy oral patches, or peeling gums often belong to dermatology, not dentistry. Patient-friendly guide to 6 oral mucosal...'},
    'dermatology-faq': {desc:'皮膚科 25 個民眾最常見問題一次解答：A 酸為什麼晚上擦？類固醇能擦多久？保養品順序？痘痘可以擠嗎？防曬要卸妝嗎？孕婦可以擦什麼？健保 vs 自費？陳翊嘉醫師整理。',desc_en:'25 common dermatology questions Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical literature and clinical guidelines.'},
    'dupilumab-long-term-maintenance': {desc:'杜避炎®（dupilumab）治療異位性皮膚炎要打多久才能停？2026 JAAD 真實世界研究 79 人追蹤 52 週：持續 q2w 平均無復發 159 天，減量竟比直接停藥更早復發。整合台灣健保條件。',desc_en:'Real-world 79-patient retrospective from Xinjiang, China, published in May 2026 JAAD, comparing three dupilumab maintenance strategies in moderate-to-severe atopic...'},
    'epidermoid-cyst': {desc:'粉瘤（表皮囊腫，epidermoid cyst)是皮下圓形腫塊，常被誤認為痘痘而擠破。本文解釋粉瘤跟痘痘怎麼分、為什麼自己擠會反覆復發、發炎時的處置、何時該開刀完整切除、健保給付條件。陳翊嘉醫師（皮膚科）整理。',desc_en:'round, mobile subcutaneous lump fundamentally different conditions Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical literature...'},
    ...
    'laser-dermatology': {desc:'皮膚科雷射完整對照：532 / 595 / 755 / 1064 / 1550 / 2940 / 10600 nm 等 11 種波長，每個對應哪些斑、痘疤、刺青、毛、紅、痣、疣的適應症與證據強度。依 2022 德國 S2k 雷射指引整理。',desc_en:'Chromophores (melanin, hemoglobin, water) 2022 German Dermatological Society S2k laser treatment guidelines “recommended / consider / not recommended”'},
    'melasma-myths': {desc:'肝斑(melasma)是亞洲女性最常見的色素困擾。雷射打一次就消？三合一藥膏越濃越好？停藥反黑？男生不會長？懷孕生完會自己消？7 個最常誤會的肝斑觀念 + 治療階梯。',desc_en:'Skin layers + melanocyte schematic Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical literature and clinical guidelines.'},
    'mpox-care': {desc:'Mpox 猴痘皮膚照護衛教：整理傳染途徑、皮疹變化、居家傷口照護、何時就醫、隔離注意事項、疫苗與皮膚科常見問題，協助患者與照護者降低傳播、搔抓感染與併發症風險，並掌握需要醫療評估的警訊與追蹤重點流程。',desc_en:'Proper skin care Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical literature and clinical guidelines.'},
    'nhi-derm-drugs': {desc:'台灣健保皮膚科常用藥物完整規範 — 口服 A 酸、Dupilumab、Adalimumab、Omalizumab、JAK 抑制劑、IL-17 / IL-23 生物製劑、Tacrolimus、MTX、Cyclosporine 給付條件、PASS 流程一次查清楚。',desc_en:'Indication, ICD-10 codes, NHI coverage criteria, dosing, treatment duration, whether PASS is required, out-of-pocket pricing'},
    'pediatric-eczema': {desc:'嬰幼兒(0-5 歲)異位性皮膚炎完整照護指南：診斷標準、好發部位、洗澡保濕、外用類固醇 / TCI 安全用法、過敏原檢測、Dupilumab 嬰幼兒適應症、共病風險。整理 2024 德國 S3 指引。',desc_en:'Infancy (birth to 1 year) ”Can I use topical steroids?” ”Will my child grow out of it?” ”Should we do allergy testing?” ”Is dupilumab really safe in infants?” 2024...'},
    'perioral-dermatitis-guide': {desc:'嘴角紅疹是痘痘還是濕疹？口周皮膚炎完整衛教：類固醇陷阱、外用 metronidazole / tacrolimus / ivermectin、口服 doxycycline 階梯式治療、台灣健保現況。整合 2026 JAAD 最新 review。',desc_en:'Patient-friendly dermatology guide to periorificial / perioral dermatitis: how to tell it apart from acne, rosacea, and eczema; the corticosteroid trap; gentle...'},
    'prurigo-nodularis': {desc:'結節性癢疹（PN）為什麼越抓越硬、越硬越癢？依 TDA 2024 共識整理診斷工具（WI-NRS、IGA-PN）、第一線外用、Dupilumab、Nemolizumab（2024 FDA 核准）、JAK 抑制劑。皮膚科醫師整理。',desc_en:'chronic, refractory, recurrent itching symmetric, firm, well-demarcated nodules itch-scratch cycle TDA 2024 PN Diagnosis and Management Consensus'},
    ...
    'skin-whitening-agents': {desc:'美白淡斑成分大解析：氫醌、傳明酸、杜鵑花酸、維他命 C、菸鹼醯胺、A 酸、麴酸、熊果素 — 每個成分機轉、有效濃度、副作用、孕期能否使用、混搭禁忌、藥用 vs 醫美 vs 保養品差別、痘疤與肝斑適用一次看完。',desc_en:'Evidence-based efficacy Real-world use Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical literature and clinical guidelines.'},
    ...
    'targeted-therapy-skin': {desc:'肺癌 NSCLC TKI 標靶藥(Gefitinib、Erlotinib、Afatinib、Osimertinib)常引起皮膚副作用：痤瘡樣皮疹、乾皮、甲溝炎、手足症候群。整合臺灣肺癌學會 + 皮膚科醫學會 2024 共識。',desc_en:'Targeted therapy Cutaneous side effects not only affect QoL but may force treatment discontinuation Taiwan Lung Cancer Society (TLCS) + Taiwanese Dermatological...'},
    'tinea-myths': {desc:'香港腳是穿不透氣鞋造成的？灰指甲塗藥膏就好？會傳染給家人？熱水泡腳能殺菌？口服抗黴菌藥傷肝？7 個最常誤會的香港腳 / 灰指甲觀念 + 口服外用治療階梯。',desc_en:'Most people use the wrong approach Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical literature and clinical guidelines.'},
    'toenail-mechanical-disorders': {desc:'腳趾甲變黃變厚不一定是灰指甲——9 成趾甲變形其實來自鞋子壓迫與腳型。12 種趾甲變形圖鑑(剝離 / 嵌甲 / Beau’s line / 夾擊甲) + 4 種足部結構異常 + 糖尿病趾甲照護。',desc_en:'Over 90% of toenail dystrophy is mechanical, not fungal. Patient-friendly guide to the 12 most common types (onycholysis, subungual heloma, Beau lines, retronychia...'},
    'topical-acids-patient': {desc:'外用酸類保養五大家族：A 酸（Tretinoin / Adapalene）、A 醇、杜鵑花酸、果酸 AHA、水楊酸 BHA — 適合誰、不能與誰併用、孕婦能否使用、會不會反黑爆痘？附入門劑量階梯與混搭禁忌表。',desc_en:'Five major topical acids Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical literature and clinical guidelines.'},
    'topical-steroids-guide': {desc:'類固醇藥膏怎麼分強弱？臉 / 身體 / 手腳該用哪一級？指尖單位(FTU)怎麼算？可以擦多久？懷孕能用嗎？7 級類固醇藥膏分類 + 台灣常見品名 + 停藥反彈 + 類固醇恐懼症解析。',desc_en:'Topical corticosteroid (TCS) phobia Right site, right potency, right duration Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical...'},
    'urticaria-myths': {desc:'蕁麻疹一定是過敏？反覆發作是免疫力差？抗組織胺會嗜睡上癮？會傳染？慢性蕁麻疹治不好？食物過敏檢測有用嗎？6 個最常誤會的蕁麻疹(風疹塊)觀念 + 治療階梯。',desc_en:'Wheal Plain-language dermatology patient education by Dr. Yi-Jia Chen, summarized from medical literature and clinical guidelines.'},
    'vitiligo': {desc:'白斑(Vitiligo)是自體免疫色素脫失疾病、全球盛行率 1-2%。依臺灣皮膚科醫學會 2024 共識整理：分節 vs 非分節型、外用 Ruxolitinib / Tacrolimus、NB-UVB / 308nm Excimer。',desc_en:'Autoimmune-mediated skin depigmentation Topical ruxolitinib (Opzelura, JAK inhibitor) received FDA approval in 2022 This article integrates the TDA 2024 vitiligo...'},
