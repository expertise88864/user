...
try { localStorage.setItem('dn_lang', code); } catch (e) {  }
...
var pct = (Math.abs(h) % 10000) / 10000;
var picked;
...
DN.PUSH_SUBSCRIBE_ENDPOINT = '/api/push-subscribe';
...
DN.GISCUS_REPO = 'expertise88864/user';
DN.GISCUS_REPO_ID = '';
DN.GISCUS_CATEGORY_ID = '';
