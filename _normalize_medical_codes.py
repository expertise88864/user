...
SLUG_CONDITIONS: dict[str, list[dict]] = {
    ...
    "atopic-dermatitis-overview": [
        medical_condition("Atopic dermatitis", "異位性皮膚炎",
                          icd10="L20.9", snomed="24079001", mesh="D003876"),
    ],
    ...
    "psoriasis-overview": [
        medical_condition("Psoriasis vulgaris", "乾癬",
                          icd10="L40.0", snomed="9014002", mesh="D011565"),
    ],
    "psoriasis-topical": [
        medical_condition("Psoriasis vulgaris", "乾癬",
    ...
    "psoriasis-special-populations": [
        medical_condition("Psoriasis with arthritis", "乾癬合併關節炎",
                          icd10="L40.5", snomed="33339001"),
    ],
    "psoriasis-myths": [
        medical_condition("Psoriasis", "乾癬", icd10="L40", snomed="9014002"),
    ],
    ...
    "acne-myths": [
        medical_condition("Acne vulgaris", "尋常性痤瘡",
                          icd10="L70.0", snomed="11381005", mesh="D000152"),
    ],
    "acne-scar-treatment": [
    ...
    "hairloss-myths": [
        medical_condition("Androgenetic alopecia", "雄性禿",
                          icd10="L64.9", snomed="87224000", mesh="D000505"),
    ],
    "alopecia-areata": [
    ...
    "vitiligo": [
        medical_condition("Vitiligo", "白斑",
                          icd10="L80", snomed="56727007", mesh="D014820"),
    ],
    "melasma-myths": [
        medical_condition("Melasma", "肝斑",
                          icd10="L81.1", snomed="2884008", mesh="D008548"),
    ],
    ...
    "rosacea-myths": [
        medical_condition("Rosacea", "玫瑰斑",
                          icd10="L71.9", snomed="33438005", mesh="D012393"),
    ],
    ...
    "urticaria-myths": [
        medical_condition("Chronic spontaneous urticaria", "慢性自發性蕁麻疹",
                          icd10="L50.1", snomed="48740009", mesh="D014581"),
    ],
    "prurigo-nodularis": [
    ...
    "hidradenitis-suppurativa": [
        medical_condition("Hidradenitis suppurativa", "化膿性汗腺炎",
                          icd10="L73.2", snomed="59393003", mesh="D017497"),
    ],
    ...
    "shingles-myths": [
        medical_condition("Herpes zoster", "帶狀皰疹",
                          icd10="B02.9", snomed="4740000", mesh="D006562"),
    ],
    "mpox-care": [
        medical_condition("Mpox", "猴痘",
                          icd10="B04", snomed="414015000", mesh="D008844"),
    ],
